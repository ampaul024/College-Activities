...
public class LinkedList2 {
    ...
    public static void combine(Iterator<String> song, Iterator<String> artist, Iterator<String> album) {

        while (song.hasNext() && artist.hasNext() && album.hasNext()) {

            System.out.println(song.next() + " - " + artist.next() + " - " + album.next());
        }
